...
/**
 * Standalone KOT counter: dashboard shell pattern (app sidebar carrying the
 * menu categories + inset header/content), without the dashboard nav itself.
 * Mount on a counter tablet, sign in once. Header mirrors the /kds
 * wallboard: brand, refresh, account chip.
 */
